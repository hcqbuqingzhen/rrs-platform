package com.rrs.common.core.constants;
...
public interface SecurityConstants {
     ...
     * 用户账号类型 -c端用户账号
     */
    String APP_ACCOUNT_TYPE = "user";
    /**
     * 商家账户
     */
    String MERCANT_ACCOUNT_TYPE = "merchant";
    /**
     * 账号类型参数名
     */
     ...
     * sms手机验证码方式授权
     */
    String  SMS_GRANT_TYPE= "mobile_sms";
}
